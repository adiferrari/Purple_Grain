...
\begin{DoxyCompactList}\small\item\em sets number of grains sets number of grains according to \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em adjusts current grain index adjusts current grain index according to \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em generates a grain table generates a grain table according to \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em calculates A\+D\+SR envelope as a single value calculates A\+D\+SR envelope as a single value in dependance of the current A\+D\+SR state given by the M\+I\+DI input \end{DoxyCompactList}\end{DoxyCompactItemize}
...
adjusts current grain index adjusts current grain index according to 


\begin{DoxyParams}{Parameters}
{\em currents\+\_\+start\+\_\+pos} & and\\
\hline
...
generates a grain table generates a grain table according to 


\begin{DoxyParams}{Parameters}
{\em current\+\_\+grain\+\_\+index} & for negative\\
\hline
{\em time\+\_\+stretch\+\_\+factor} & values samples are read in backwards direction \\
\hline
...
sets number of grains sets number of grains according to 


\begin{DoxyParams}{Parameters}
{\em soundfile\+\_\+length} & and\\
\hline
{\em grain\+\_\+size\+\_\+samples} & \\
\hline
...
$<$ sets current position to start